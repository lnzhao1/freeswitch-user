...
CREATE TABLE `sip`  (
                        ...
                        `user` varchar(110) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户名',
                        `pwd` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '密码',
                        `creat_at` datetime NULL DEFAULT NULL,
                        `user_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
                        PRIMARY KEY (`id`) USING BTREE,
                        UNIQUE INDEX `sip_user`(`user`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sip
-- ----------------------------
INSERT INTO `sip` VALUES (1, '1000', '1234', NULL, '1000');
INSERT INTO `sip` VALUES (2, '1001', '1234', NULL, '1001');
INSERT INTO `sip` VALUES (3, '1002', '1234', NULL, '1002');
INSERT INTO `sip` VALUES (4, '1090', '1234', NULL, '1090');
INSERT INTO `sip` VALUES (5, '8088', '1234', NULL, '8088');
INSERT INTO `sip` VALUES (6, '253', '1234', NULL, '253');
INSERT INTO `sip` VALUES (7, '80888', '1234', NULL, '80888');
INSERT INTO `sip` VALUES (8, '1081', '1234', NULL, '1081');
